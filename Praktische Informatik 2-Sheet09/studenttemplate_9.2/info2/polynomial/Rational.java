 ...
 * A rational number x is represented by a fraction:
 *    a   numerator (int)
 *    -
 *    b   denominator (int)
 *
...
public class Rational {
     ...
     * @return Result as a new Rational instance.
     */
    public Rational div(final int other) {
     ...
     * @return Result as a new Rational instance.
     */
    public Rational add(final int other) {
     ...
     * @return Result as a new Rational instance.
     */
    public Rational sub(final int other) {
